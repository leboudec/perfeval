...
\providecommand{\Ifignc}[3]{% same as Ifig, no centering
 \includegraphics[width=#2\textwidth,height=#3\textwidth]{#1}
 \footnote{\fbox{\texttt{file: #1}}}
 }
...
%% modified LEB 2026 to avoid minipage overflow

\newlength{\labelthm}
\setlength{\labelthm}{7cm}
\newenvironment{shadethm}
{\par\noindent{\gray\rule{\labelthm}{1pt}}\par\vspace*{-.2\baselineskip}\begin{theorem}}
{\end{theorem}\nobreak\par\nobreak{\gray\hfill\rule{\labelthm}{1pt}}\par}
...
% framesep=10pt]{\usebox{\coloredbox}}}
\newenvironment{sh}
{\par\noindent{\gray\rule{\labelthm}{1pt}}\par\vspace*{-.2\baselineskip}}
{\nobreak\par\nobreak{\gray\hfill\rule{\labelthm}{1pt}}\par}
