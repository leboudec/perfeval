...
\centering
 ...
 \subfigure[$x=0.7$, $y=0.8$]{\ifig{throughput-x=0.7y=0.8}{0.45}}
 \subfigure[$x=0.7$, $y=1$]{\ifig{throughput-x=0.7y=1}{0.45}}
 \subfigure[$x=0.5$, $y=1.2$]{\ifig{throughput-x=0.5y=1.2}{0.45}}
...
function in isolation, such that $F(\emptyset)= 1$, where $\emptyset$ is the empty state, and the
